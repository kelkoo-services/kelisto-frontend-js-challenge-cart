...
const IconBasket = ({ size = 4 }) => {
  return (
    <svg className={`h-${size} w-${size} fill-current`} id="Shopping_basket" xmlns="http://www.w3.org/2000/svg" x="0px"
      y="0px" viewBox="0 0 20 20" enableBackground="new 0 0 20 20" >
      <path fill="#FFFFFF" d="M18.399,7h-5.007L11.58,8.812c-0.453,0.453-1.056,0.702-1.696,0.702c-0.642,0-1.244-0.25-1.698-0.703
