...
const IconTrash = ({ size = 4 }) => {
  return (
    <svg className={`h-${size} w-${size} fill-current`} id="Trash" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
      viewBox="0 0 20 20" enableBackground="new 0 0 20 20" >
      <path fill="#FFFFFF" d="M3.389,7.113L4.49,18.021C4.551,18.482,6.777,19.998,10,20c3.225-0.002,5.451-1.518,5.511-1.979
